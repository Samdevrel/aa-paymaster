      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Account Abstraction gas management for agent wallets and smart account systems.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Fund paymaster contract</li>
            <li>Cover gas for user operations</li>
            <li>Support custom payment mechanisms</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ Custom payment schemes</li>
            <li>✓ Budget management</li>
            <li>✓ Multi-signature support</li>
            <li>✓ Transparent gas accounting</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Fund gas budget</li>
            <li>Configure payment rules</li>
            <li>Enable for user operations</li>
          </ol>
        </section>
